...
public class Token
{
    ...
    final static public List<String> types = Arrays.asList(Token.Classifications.INTEGER.toString(), Token.Classifications.REAL.toString(), Token.Classifications.BOOLEAN.toString());
